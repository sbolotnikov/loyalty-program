...
const LoginScreen = () => {
  ...
  return (
    <KeyboardAwareScrollView>
      <Layout>
        <View
          style={tw`max-w-[800px] w-full h-[85%] justify-center items-center`}>
          <Text style={tw`text-4xl font-extrabold mb-2 text-[#3D1152]`}>
            Login
          </Text>
          <Text style={tw`font-bold text-base text-justify m-2 text-black`}>
            Joining Fred Astaire Rewards means unlocking access to exclusive
            benefits and gifts.
          </Text>
          {!!error && (
